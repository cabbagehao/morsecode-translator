          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Morse Coder.</li>
                ...
                <li><strong>Website</strong> refers to Morse Coder, accessible from <a href="https://morse-coder.com" className="text-blue-600 dark:text-blue-400 hover:underline">https://morse-coder.com</a></li>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
                <li>By email: <a href="mailto:yhc2073@gmail.com" className="text-blue-600 dark:text-blue-400 hover:underline">yhc2073@gmail.com</a></li>
                <li>By visiting this page on our website: <a href="https://morse-coder.com" className="text-blue-600 dark:text-blue-400 hover:underline">https://morse-coder.com</a></li>
              </ul>
            </section>
          </div>
        </div>
