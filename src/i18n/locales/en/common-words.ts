export const enCommonWords = {
  ...
  categories: {
    basicResponses: "📢 Basic Responses in Morse Code",
    emergencyWords: "🆘 Emergency Words in Morse Code",
    actionWords: "⚡ Action Words in Morse Code",
    commonArticles: "📝 Common Articles & Pronouns in Morse Code",
    numbers: "🔢 Numbers in Morse Code",
    colors: "🎨 Colors in Morse Code",
    timeWords: "⏰ Time Words in Morse Code",
    objects: "🏠 Objects & Places in Morse Code",
    otherWords: "📚 Other Common Words in Morse Code"
  },
  quickReference: {
    title: "Quick Reference Categories for Morse Code",
    items: [
      "📢 Basic Responses in Morse Code (YES, NO, HELLO)",
      "🔢 Numbers in Morse Code (ONE, TWO, THREE)",
      "🎨 Colors in Morse Code (RED, BLUE, GREEN)",
      "🆘 Emergency Words in Morse Code (HELP, STOP, WAIT)"
    ]
  },
  totalStats: {
    title: "📊 Total Morse Code Words: {count}",
    breakdown: {
      basicResponses: "📢 Basic Responses in Morse Code: {count}",
      emergencyWords: "🆘 Emergency Words in Morse Code: {count}",
      actionWords: "⚡ Action Words in Morse Code: {count}",
      articles: "📝 Articles in Morse Code: {count}",
      numbers: "🔢 Numbers in Morse Code: {count}",
      colors: "🎨 Colors in Morse Code: {count}",
      timeWords: "⏰ Time Words in Morse Code: {count}",
      objects: "🏠 Objects in Morse Code: {count}",
      otherWords: "📚 Other Words in Morse Code: {count}"
    }
  },
  learningTips: {
